...
.. c:function:: int coresight_register(FAR struct coresight_dev_s *csdev,
.. c:function::                        FAR const struct coresight_desc_s *desc);
...
.. c:function:: int coresight_enable(FAR struct coresight_dev_s *srcdev,
.. c:function::                      FAR struct coresight_dev_s *destdev);
